...
<body>
		<video class="v" controls autoplay="autoplay"
		  ...
		  <source src="./vid/footing.mp4" type='video/mp4'>
		  <source src="vid/footing.ogv" type="video/ogg"/>
		  <source src="./vid/footing.webm" type='video/webm'>
		  <script>
		  setTimeout(function(){
			  window.location =
			  "http://zeega.com/97945";}, 29000);
		  </script>
		</video>
